...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("teste", "ignjam-2016", "ignjam-2016", "1.0.0");
		...
		telemetryConfig.app_name = "ignjam-2016";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "ignjam-2016", null, { width: 640, height: 480 });
